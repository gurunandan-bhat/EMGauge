...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
		...
		<link rel="stylesheet" href="<!-- TMPL_VAR NAME=DOCBASE -->css/emgauge.css" type="text/css" media="screen, projection" />
		<script type="text/javascript" src="<!-- TMPL_VAR NAME=DOCBASE -->js/jquery.min.js"></script>
		<script type="text/javascript" src="<!-- TMPL_VAR NAME=DOCBASE -->js/jquery.validate.pack.js"></script>
		<script type="text/javascript" src="<!-- TMPL_VAR NAME=DOCBASE -->js/mailer_upload.js"></script>    
		<title>Create Mailer: Start</title>
    </head>
	<body>
		<div class="container">
			...
			<div class="prepend-3 span-18 append-3 last formholder">
				<div class="innerholder">
					<div class="prepend-1 span-9 append-1">
						<form enctype="multipart/form-data" id="metamailer" action="step2" method="post">
