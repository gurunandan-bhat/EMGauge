		...
		<div class="container">
			...
			<div class="prepend-6 span-12 append-6 last">
				<form  name="registerform" method="post" action="user.cgi">
					<fieldset>
						<legend>Change Password for <!-- TMPL_VAR NAME=USERNAME --></legend>
						...
						<p>
							<input tabindex="3" type="submit" name="change" value="Change" />
						</p>
					</fieldset>
					<input type="hidden" name="rm" value="changepassword" />
				</form>
			</div>
		</div>
	</body>
